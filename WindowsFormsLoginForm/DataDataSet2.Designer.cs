...
namespace WindowsFormsLoginForm {
    ...
    public partial class DataDataSet2 : global::System.Data.DataSet {
        ...
        public partial class AddressDataTable : global::System.Data.TypedTableBase<AddressRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AddressRow AddAddressRow(int PersonId, string StreetAddress, string City, string State, string Zip) {
        ...
        public partial class AddressRow : global::System.Data.DataRow {
            ...
            public string StreetAddress {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'StreetAddress\' in table \'Address\' is DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsStreetAddressNull() {
                return this.IsNull(this.tableAddress.StreetAddressColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetStreetAddressNull() {
                this[this.tableAddress.StreetAddressColumn] = global::System.Convert.DBNull;
            }
...
namespace WindowsFormsLoginForm.DataDataSet2TableAdapters {
    ...
    public partial class AddressTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Address] WHERE (([Id] = @Original_Id) AND ([PersonId] = @Original_PersonId) AND ((@IsNull_StreetAddress = 1 AND [StreetAddress] IS NULL) OR ([StreetAddress] = @Original_StreetAddress)) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_State = 1 AND [State] IS NULL) OR ([State] = @Original_State)) AND ((@IsNull_Zip = 1 AND [Zip] IS NULL) OR ([Zip] = @Original_Zip)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Address] ([PersonId], [StreetAddress], [City], [State], [Zip])" +
                " VALUES (@PersonId, @StreetAddress, @City, @State, @Zip);\r\nSELECT Id, PersonId, " +
                "StreetAddress, City, State, Zip FROM Address WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Address] SET [PersonId] = @PersonId, [StreetAddress] = @StreetAddress, [City] = @City, [State] = @State, [Zip] = @Zip WHERE (([Id] = @Original_Id) AND ([PersonId] = @Original_PersonId) AND ((@IsNull_StreetAddress = 1 AND [StreetAddress] IS NULL) OR ([StreetAddress] = @Original_StreetAddress)) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_State = 1 AND [State] IS NULL) OR ([State] = @Original_State)) AND ((@IsNull_Zip = 1 AND [Zip] IS NULL) OR ([Zip] = @Original_Zip)));
SELECT Id, PersonId, StreetAddress, City, State, Zip FROM Address WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, PersonId, StreetAddress, City, State, Zip FROM dbo.Address";
        ...
        public virtual int Fill(DataDataSet2.AddressDataTable dataTable) {
        ...
        public virtual DataDataSet2.AddressDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataDataSet2.AddressDataTable dataTable = new DataDataSet2.AddressDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataDataSet2.AddressDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, int Original_PersonId, string Original_StreetAddress, string Original_City, string Original_State, string Original_Zip) {
        ...
        public virtual int Insert(int PersonId, string StreetAddress, string City, string State, string Zip) {
        ...
        public virtual int Update(int PersonId, string StreetAddress, string City, string State, string Zip, int Original_Id, int Original_PersonId, string Original_StreetAddress, string Original_City, string Original_State, string Original_Zip, int Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int PersonId, string StreetAddress, string City, string State, string Zip, int Original_Id, int Original_PersonId, string Original_StreetAddress, string Original_City, string Original_State, string Original_Zip) {
            return this.Update(PersonId, StreetAddress, City, State, Zip, Original_Id, Original_PersonId, Original_StreetAddress, Original_City, Original_State, Original_Zip, Original_Id);
        }
    }
